...
fun main () {
    ...
    val product5 = Product("Tomaten", 100.0, 4)
    ...
    //8
    val foldMax = fold(list, 0.0, {max, next -> maxOf(max, next.price)})
    println("8) $foldMax")
